#!/bin/bash
#SBATCH --job-name=pred_scenario3a
#SBATCH --output=logs/%j_predict_scenario3a.txt
#SBATCH --error=logs/%j_predict_scenario3a_error.txt
...
echo "🚀 Starting Scenario 3A cross-region predictions at $(date)"
echo "📊 Scenario 3A: GEDI from-scratch + Fixed Ensemble"

# --- Configuration ---
GEDI_MODEL="chm_outputs/google_embedding_scenario3a/gedi_unet_model/shift_aware_unet_r2.pth"
REFERENCE_MODEL="chm_outputs/production_mlp_reference_embedding_best.pth"
ENSEMBLE_MLP="chm_outputs/google_embedding_scenario3a/ensemble_model/ensemble_mlp_best.pth"
OUTPUT_DIR="chm_outputs/google_embedding_scenario3a_predictions"
...
echo "✅ Scenario 3A predictions completed at $(date)"

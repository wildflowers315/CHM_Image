...
#SBATCH --job-name=s2b_predict_tochigi
#SBATCH --output=logs/%j_s2b_predict_tochigi.txt
#SBATCH --error=logs/%j_s2b_predict_tochigi_error.txt
...
# Run the prediction for Tochigi
